...
public class CustomeListviewOfFemaleOrderDone extends BaseAdapter {
    Context context;
    ArrayList<FemaleViewOrderData_OFF_Mode_GetterSetter> list = new ArrayList();

    CustomeListviewOfFemaleOrderDone(Context context, ArrayList<FemaleViewOrderData_OFF_Mode_GetterSetter> list) {
