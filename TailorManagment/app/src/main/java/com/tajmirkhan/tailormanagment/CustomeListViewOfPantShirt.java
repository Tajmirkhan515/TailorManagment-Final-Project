...
public class CustomeListViewOfPantShirt extends BaseAdapter {

    Context context;
    ArrayList<PantShirtData> list=new ArrayList();
    CustomeListViewOfPantShirt(Context context, ArrayList<PantShirtData> list){
