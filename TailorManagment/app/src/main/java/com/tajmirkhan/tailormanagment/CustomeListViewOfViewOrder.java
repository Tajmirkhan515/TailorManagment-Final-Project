...
import static com.tajmirkhan.tailormanagment.R.id.imageview;

/**
 * Created by Tajmir khan on 11/20/2017.
 */

public class CustomeListViewOfViewOrder  extends BaseAdapter {

    Context context;
    ArrayList<View_Order_Data_setter_getter> list=new ArrayList();
    CustomeListViewOfViewOrder(Context context, ArrayList<View_Order_Data_setter_getter> list){
    ...
    public View getView(int position, View view, ViewGroup viewGroup) {
        ...
        username.setText("Name "+list.get(position).getName());
