...
public class AddPhotoOfMale extends AppCompatActivity {
ImageView imageview;
    EditText edt;
    Button btn_save;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.add_photo_of_male_activity);
        ...
        btn_save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(edt.getText().toString().equals("")){
                    Toast.makeText(AddPhotoOfMale.this, "pleas Enter Name", Toast.LENGTH_SHORT).show();
                }else
                {
                    if(checkdesign.equals("")){
                        Toast.makeText(AddPhotoOfMale.this, "pleas select the choice", Toast.LENGTH_SHORT).show();
                    }
                    else
                        {
                    ...
                    edt.setText("");
                    Toast.makeText(AddPhotoOfMale.this, "data is saved", Toast.LENGTH_SHORT).show();
                finish();
                        }
                }
            }
