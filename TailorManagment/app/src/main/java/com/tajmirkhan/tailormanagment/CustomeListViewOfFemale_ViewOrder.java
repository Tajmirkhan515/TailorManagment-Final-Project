...
public class CustomeListViewOfFemale_ViewOrder extends BaseAdapter {
    ArrayList<Female_ViewOrder_Data> list=new ArrayList<>();
    Context context;

    public CustomeListViewOfFemale_ViewOrder(Context context,ArrayList<Female_ViewOrder_Data> list){
    ...
    public View getView(int position, View view, ViewGroup viewGroup) {
        ...
        DatabaseFemale db=new DatabaseFemale(context);
