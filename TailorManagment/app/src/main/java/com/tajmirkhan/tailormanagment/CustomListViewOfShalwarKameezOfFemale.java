...
public class CustomListViewOfShalwarKameezOfFemale extends BaseAdapter {
    Context context;
    ArrayList<Female_ShalwarKameez_Data> list;

    public CustomListViewOfShalwarKameezOfFemale(Context context,ArrayList<Female_ShalwarKameez_Data> list){
